...
class Distrik extends MY_Controller {
	...
	public function index(){
		...
		$data['distrik_list'] = $this->model_global->get_data(array('select' => '*', 'table' => 'district_campaign','where' => array('status' => 1), 'order_by' => 'urutan asc'));
		$this->load->view('front/podcast/header',$data);
		$this->load->view('front/podcast/distrik',$data);
