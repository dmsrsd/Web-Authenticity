		...
		if($row['id_soundroom']!=""){
			...
			<div class='$class '>
				<div class='box-soundroom'>
					...
					<div class='row'>
						<div class='col-md-12'>
							<a class='btn btn-md btn-block $vote' id='vovote' id='btnv-$row[id_soundroom]' data-res='$row[id_soundroom]'><i class='fa fa-plus'></i> Vote &amp; Share</a>
						</div>
					</div>
				</div>
			</div>
					...
					$html.= "<tr class='trbody  play-$row[slug] klikplaylist ' id='play-$row[slug]' data-no='$no' data-band='$row[slug]'>
						<td width='150' align='center'>
							...
							<div class='playno playno-$row[slug] hide'>
								<a href='javascript:void(0);' onClick=\"currentplaytop(this)\" class='icon $bp pl-$no idpl-$row[id_soundroom]' data-now='$no' data-audio1='a1-$row[id_soundroom]' data-audio='".base_url()."uploads/soundroom/$row[sound]' data-band='$row[slug]' data-progress='prog-$row[id_soundroom]' data-progress1='prog1-$row[id_soundroom]'><i class='fa fa-play'></i></a>
							</div>
						</td>
						<td>$row[judul]</td>
