...
<div class='min-height'>
	<div class='container'>
		<div class='row'>
			<div class='col-sm-2'>
				<br>
				<img src='<?=base_url()?>uploads/contributor/<?=$kontributor['image'];?>' class='img-responsive' style='width:100%;'>
			</div>
			<div class='col-md-8'>
				<h1 class='head-article'><?=$kontributor['nama'];?></h1>
				<h2 class='head2-article'>
					<?=$kontributor['deskripsi'];?>
				</h2>
				<div class='content-article'>
					<?=$kontributor['deskripsi2'];?>
					<div class='cl'></div>
				</div>
			</div>
		...
		<div class='row'>
			<div class='col-md-12'>
				<h1 class='head-section'>Article by : <?php echo ucwords($kontributor['nama'])?></h1>
			</div>
		</div>
