							...
							echo"
								<div class='col-sm-3'>
									<div class='boxgallery' style='padding:5px; height:250px;'>
										<br>
										<img class='clickthumb' src='".base_url()."uploads/designcompetition/thumb/".$row[$row['cover']]."' data-box='$row[box]' data-lighter='$row[lighter]' data-tincase='$row[tincase]' data-title='".$row['fullname']." - ".namadatetime($row['created_date'],FALSE)."' style='width:100%; cursor:pointer;'><br><br>
