...
<!-- Google tag (gtag.js) -->
    ...
    #appLoader.is-active{ display:flex; }
    .btn-with-loader{
        display:inline-flex; align-items:center; gap:8px;
        padding:.6rem 1rem; border:1px solid #e5e7eb; border-radius:10px;
        background:#fff; color:#111827; cursor:progress;
    }
    .mini-spinner{
...
<button id="appLoader" class="btn-with-loader">
					...
					<div class="col-md-12 box-body" style="min-height: 300px">
						<div class="row">
							...
							<div class="col-md-8">
								<p></p>
								<div class="row">
									<div class="col-md-12 text-center"><h3 class="button-nav2 text-but" onclick="kirimData(this,'<?php echo base_url('elite/shareemails/'.$this->uri->segment(3).'?id='.$member['id_member']); ?>')" style="cursor: pointer;">Send Email
                                    </h3></div>
