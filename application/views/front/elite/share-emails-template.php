...
<div class='kurung'>
	...
	<div class='isi' align='center'>
		<?php if($this->uri->segment(3)==1){ ?>
			<img src="<?php echo $url= base_url('assets/elite-html/images/flower.jpeg') ?>" class="img-responsive">
		<?php } else if($this->uri->segment(3)==2){ ?>
			<img src="<?php echo $url= base_url('assets/elite-html/images/star.jpeg') ?>" class="img-responsive">
		<?php } else { ?>
			<img src="<?php echo $url= base_url('assets/elite-html/images/love.jpeg') ?>" class="img-responsive">
		<?php } ?>
	</div>
	<div class='footer'>
