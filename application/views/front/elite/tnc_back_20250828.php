					...
					<div class="row">
						<div class="col-md-12 box-head"></div>
							<div class="col-md-12 box-body tnc">
								...
								<p>*Isi data berikut supaya lo eligible buat dapetin exclusive merchandise dan elite experience dari Authenticity di konser paling hype di 2025. Langsung gas lengkapin form di bawah ini :</p>-->
								...
								<div class="row">
									...
									<div class="col-md-5">
										<input type="text" class="form-control" name="fullname" maxlength="50" value="<?php echo $member['fullname'] ?>" <?php if(empty($this->datamember)){ ?>readonly<?php } ?> required>
									</div>
								</div>
								<div class="row">
									<div class="col-md-7">
