						...
						<div class="col-lg-8 col-md-10">
							<div class="card card--shadow">
								<form action="<?php echo base_url(); ?>unlock/prosesconfirm" id="myForm" method="post" data-parsley-validate enctype="multipart/form-data">
									...
									<input type="hidden" name="type" value="silver" style="display: none">
									<div class="row">
										<div class="col-lg">
											<h3>Upload Photo Booth Dengan Merchandise</h3>
											<div class="form-group">
												...
												<!-- <input type="text" class="form-control " required maxlength="100" placeholder="Lokasi Event" name="pembelian"> -->
											</div>
											<div class="form-group">
												<label for="email">Photo Booth dengan merchandise : </label>
