			...
			<nav class="navbar navbar-default navbar-fixed-top" role="navigation" >
				<div class="container-fluid">
					<div class="navbar-header" id="myGroup">
						...
						<div class="navbar-brand navbar-brand-centered"><a href='<?=base_url()?>'><img src='<?php echo base_url()?>uploads/logocity.png' style='width:130px;'></a></div>
					</div>

					<div id="navbar" class="navbar-collapse collapse" aria-expanded="false" style="height: 1px;">
						<ul class="nav navbar-nav menu-mobile">

							<?php /*?><li class='din'><a href="<?=base_url()?>" style=' padding:15px 15px;'><img src='<?php echo base_url()?>uploads/logocity2.png' style='width:200px;'></a></li><?php */?>
							<?php
							if(empty($this->datamember)){
							?>
							<li class='din menu-center  hidden-sm hidden-md hidden-lg'><a href="<?=base_url()?>login" class="menupodcast">Login</a></li>
							<li class='din menu-center  hidden-sm hidden-md hidden-lg'><a href="<?=base_url()?>register" class="menupodcast">Sign Up</a></li>
							<?php
							}else{
							?>
							<li class='din menu-center  hidden-sm hidden-md hidden-lg'><a href="<?=base_url()?>profile" class="menupodcast">Hi, <?=ucwords($this->datamember['fullname']);?></a></li>
							<li class='din menu-center hidden-sm hidden-md hidden-lg'><a href="<?=base_url()?>profile/out" class="menupodcast">Sign Out</a></li>
							<?php }?>
							<li class=' menu-center img-desktop' style='float:right;bottom: -6px;'>
								<div class='bg-skew'>
							...
							<li class=' menu-center lipodcast' style='float:right;'><a href="<?=base_url()?>lab" class="<?=cur("lab",$top);?> menupodcast">AUTHENTICITY LAB</a></li>
							<li class=' menu-center lipodcast' style='float:right;'><a href="<?=base_url()?>podcast/naik-clas" class="<?=cur("naik-kelas",$top);?> menupodcast">PODCAST NAIK CLAS</a></li>
