...
<meta http-equiv="Content-Security-Policy" content="default-src 'self' *.moengage.com cdn.moengage.com;script-src 'self' 'unsafe-inline' *.moengage.com cdn.moengage.com;style-src 'self' 'unsafe-inline' 'unsafe-hashes' fonts.googleapis.com fonts.bunny.net *.moengage.com cdn.moengage.com;img-src 'self' data: *.moengage.com moe-email-campaigns.s3.amazonaws.com;font-src 'self' fonts.googleapis.com fonts.gstatic.com *.moengage.com cdn.moengage.com;connect-src 'self' *.moengage.com;frame-src 'self' *.moengage.com;media-src 'self' *.moengage.com;">
