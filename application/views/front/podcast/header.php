			...
			<div class="collapse navbar-collapse" id="navbarMain">
				...
				<li class="dropdown">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
								<!--<li><a href="<?php echo site_url('duoverse'); ?>">Duoverse Circle</a></li>-->
								<li><a href="<?php echo site_url('tarotunes'); ?>">Tarotunes</a></li>
						</ul>
					</li>
					
					<!--<li><a href="<?php echo site_url('tarotunes'); ?>" target="_blank">Tarotunes</a></li>-->
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
								...
								<li><a href="<?php echo site_url('hangout'); ?>">Hangout</a></li>
						</ul>
					</li>
					<!-- <li><a href="<?php echo site_url('event'); ?>">Event</a></li> -->
					<!--<li><a href="<?php echo site_url('article'); ?>">News</a></li>-->
					
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Articles</a>	
						<ul class="dropdown-menu">
								<li><a href="<?php echo site_url('article'); ?>">All Articles</a></li>
								<li><a href="<?php echo site_url('category/music/all'); ?>">Classified Music</a></li>
								<li><a href="<?php echo site_url('category/culture/all'); ?>">Classified Culture</a></li>
