...
<div class='min-height'>
	<div class='container'>
		<div class='row'>
			<div class='hides col-sm-12'>
			<a href="https://www.authenticity.id/memorirasamatraman" ><img src="https://www.authenticity.id/uploads/newcampaign/podcast_1974_new_competition_banner2.png" width="100%"></a>
...
<h2>Masih banyak jalan buat<br>nambahin point lo!</h2>
							...
							<a href='<?=base_url();?>category/music/all'>Read &amp; Share Articles</a>
							...
							<!--<a <?=$h2;?>>Authenticity SoundRoom Submission</a>-->
							<!--<a href='<?=base_url();?>https://www.authenticity.id/design-competition-with-darbotz'>Kreasi Donasi Design Competition</a>-->
							...
							<div class='get-member'>
					<a href='javascript:void(0);' class='share-code btn btn-block btn-sred' >Share Referral Code!</a>
				</div>
							<!--<a href="https://www.authenticity.id/design-competition-with-darbotz" ><img src="https://www.authenticity.id/uploads/kotak-darbotz-small.jpg" width="100%"></a>-->
	...
	<br>
	<?php
	if(isset($darbotzorder) && count($darbotzorder) > 0){
	?>
	<br>
	<div class='container'>
		<h1 class='head-blue'>Your Darbotz KREASI DONASI BOX SET Order</h1>
		<br>
		<div class='row'>
			<div class='col-sm-12'>
			...
			<?php
			$no=1;
			if(isset($darbotzorder) && count($darbotzorder) > 0){ foreach($darbotzorder as $row){
				$darbotz = $this->model_global->get_data(array('data' => 'row','table' => 'darbotz', 'where' => array( 'id_darbotz' =>$row['id_darbotz'])));
				$status = $row['mtransaction_status'];
				echo "
					<tr>
						...
						<td>".namadatetime($row['pay_date'])."</td>
						<!--<td><a href='".base_url()."mpay/status/$row[morder_id]' class='btn btn-sm btn-red'><i class='fa fa-eye'></i> Check</a></td>-->
					</tr>
				";
				$no++;
			}}
			...
			if(isset($order) && count($order) > 0){ foreach($order as $row){
				...
				echo "
					<tr>
						...
						<td><a href='".base_url()."dpay/status/$row[inv]' class='btn btn-sm btn-red'><i class='fa fa-eye'></i> Check</a></td>
					</tr>
				";
				$no++;
			}}
	...
	<div class="container">
		<div class="row">
			<div class="col-md-7">
				<div class="row">
					<div><img src='<?php echo base_url()?>uploads/logo__redem.png' class="img-responsive"></div>
					<div><img src='<?php echo base_url()?>uploads/point__redem.png' class="img-responsive"></div>
				</div>
				</div>
			<div class="col-md-5">
			</div>
					...
					<div class='col-md-4 col-sm-6' style='margin-bottom:20px;'>
						<div class='border-rewards'>
							...
							<div class='container-rewards product-div1'>
								<img src='".base_url()."uploads/redeem/$row[image]' alt='$row[nama]'  class='transition img-rounded' style='width:100%;filter: brightness(0.5);'>
								<div class='centered'><h1><a href='javascript:void(0)' class='$btnredeem' id='btnv-$row[id_redeempoint]' data-res='$row[id_redeempoint]'>$row[nama]<br><br><span style='padding:3px; background:#0355A1;'>$row[point] Point</span></a></h1></div>
							</div>
						</div>
					</div>
				";
