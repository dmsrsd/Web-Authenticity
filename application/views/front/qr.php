...
<div class='min-height'>
	<div class='container'>
		<div class='row'>
			<div class='col-sm-12'>
				<h1 align='center' class='head-rewards'>On Ground</h1>
					<br>
<div align='center'>Fitur ini hanya dapat digunakan saat lo datang ke acara Authentic On Ground untuk aktivasi menyenangkan.
<br>
<br>
Stanby sama HP lo, kalau liat tanda barcode langsung scan aja demi tambahan poin!</div>
...
<script type="module"  src="<?php echo base_url()?>assets/front/js/module.js?r=<?=rand();?>"></script>
...
<script src="<?php echo base_url()?>assets/front/js/nomodule.js?r=<?=rand();?>" nomodule defer></script>
<script>
