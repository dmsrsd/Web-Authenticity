				...
				<div class="form-group">
					<div class='row'>
						<div class='col-sm-6'>
							...
							<select class='form-control rokok' name='id_provinsi' id="id_provinsi" onchange="getKotaByProv(this.value)">
								<option value=''>--</option>
								<?php
						...
						<div class='col-sm-6'>
							<label>City</label>
							<select class='form-control kota' name='id_kota' id="id_kota" onchange="getKecByKota(this.value)" >
								<option value=''>--</option>
							</select>
						</div>
						<div class='col-sm-12' style="display:none">
							<label>District</label>
							<select class='form-control kec' name='district' id="id_kec" >
								<option value=''>--</option>
							</select>
						</div>
