	...
	<div class="container-fluid px-0">
		<div class="row align-items-start gx-0">
			<div class="col-lg-8 banner-left">
				<div class="page-soundroom__banner">
					<?php
						...
						<div class="page-soundroom__cta">
							...
							if ($valid_date < $limit_date) { ?>
								<?php if (empty($this->datamember)) { ?>
									<a href='<?php echo site_url("login?to=profile/soundroom?year=2024") ?>'>
										<img src='<?= base_url() ?>assets/front/img/soundroom/btn-cta.png'>
									</a>
								<?php } else { ?>
									<a href='<?php echo site_url("profile/soundroom?year=2024") ?>'>
										<img src='<?= base_url() ?>assets/front/img/soundroom/btn-cta.png'>
									</a>
								<?php } ?>
				...
				<div class="page-soundroom__playlist">
					<div class="playlist-filter">
						<div class="row justify-content-between align-items-center">
							...
							<?php if($season == '2024' || $season == '2023' || $season == '') { ?>
							<div class="col-auto">
			...
			<?php if ($season == '2024'){ ?>
				<div class="col-lg-12">
					<div class='container'>
						<img src='<?= base_url() ?>assets/front/img/soundroom/banner-2024.png' width="100%">
					</div>
				</div>
			<?php } ?>
		</div>
