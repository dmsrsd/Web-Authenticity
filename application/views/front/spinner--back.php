                ...
                <div id="wrapper">
                  ...
                  <div id="txt"></div>
								...
								<div class="content-spinner">
									<p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Mollitia excepturi soluta nemo quisquam nesciunt deserunt hic ab autem modi suscipit amet, aliquam aperiam distinctio eligendi numquam voluptatem non. Facere, placeat.</p>
									<!-- <input class="btn btn-spin" type="button" value="PUTAR"/> -->
								</div>								
							</div>
						</div>
					</div>
...
$(document).ready(function() {
  $('#spin').click(function() {    
      //totalDegree = 18099;  //zipo
      //totalDegree = 18000; //ipone
      //totalDegree = 18030; //tws
      //totalDegree = 18080; //speaker
      //totalDegree = 18160; //vintage box set
      //totalDegree = 18190; //vintage suno bag
      //totalDegree = 18220; //vintage tumbler
      //totalDegree = 18260; //vintage jersey
      totalDegree = 18300; //coba lagi
      ...
      setTimeout(function () {
        alert('yah coba lagi dikesempatan lain nanti');
        //jalakan ajax
