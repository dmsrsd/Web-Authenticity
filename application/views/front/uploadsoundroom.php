						...
						<form role="form" id="frmWrite" action="<?= base_url() ?>profile/submitsoundroom" method="post" data-parsley-validate enctype="multipart/form-data">
							<div class="panel-body pt-5">
								...
								<div class="form-group">
									...
									<input type="judul" class="form-control " id="judul" maxlength="150" placeholder="Nama Band" name="judul" value="<?= $band_old['judul'] ?>">
								...
								<!--
								<div class="form-group">
									<table width='100%' class='table' id='listable'>
										<tr>
											<th width='250'>Personil</th>
											<th>Position</th>
											<th width='50'></th>
										</tr>
										<tr>
											<td><input type='text' name='personil[]' class='form-control' placeholder='Personil Name'></td>
											<td><input type='text' name='position[]' class='form-control' placeholder='ex: Vocalist, Guitar, Bass, Drum etc.'></td>
											<td align='center'><a href='javascript:void(0);' class='btn btn-sm btn-success addpersonil'><i class='fa fa-plus'></i></a></td>
										</tr>
									</table>
								</div>
								-->
								...
								<div class="form-group">
									...
									<input type="text" class="form-control " id="pic" maxlength="150" placeholder="Nama PIC" name="pic" value="<?= $band_old['pic'] ?>">
								</div>
								<div class="form-group">
