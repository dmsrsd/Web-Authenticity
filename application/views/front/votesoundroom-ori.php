		...
		<section class="section-participants">
			...
			<div class="row">
				<div class="col-lg-12 text-center" style="margin: 40px 0">
					<button  onclick="openVoteModal(event)" type="button" style="border: none; cursor: pointer; "><img src="<?= base_url() ?>assets/front/img/soundroom/vote/button_submit.png" class="img-fluid" style="cursor: pointer;"></button>
				</div>
			</div>
		</section>
	<!--END THUMBNILE-->
