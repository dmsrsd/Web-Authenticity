...
<div class="panel-heading">
	<div class="row">
		...
		<div class='col-sm-6' align='right'>
			<a href="<?=$url?>slide-new" class="btn btn-success btn-sm"><i class=" fa fa-plus"></i> Tambah</a>
		</div>
	</div>
</div>
		...
		<table class="table table-striped table-bordered table-hover dataTables" >
			...
			<tbody>
				...
				<tr>
					...
					<td align='center'>
						<a class='fancybox fancybox.iframe' href='<?php echo base_url()."uploads/slide/".$row['image'];?>'><img class='img-rounded' height="100" src='<?=isset($row['image']) ? base_url()."uploads/slide/".$row['image'] : base_url().'uploads/no_image.png'?>'></a>
					</td>
					<td align='center'>
						<?php echo isset($row['status_youtube']) ?  $status[$row['status_youtube']] : '-'?>
					</td>
					<td align='center'>
					...
					<td align='center'>
						<a title="Edit" href="<?=$url?>slide-new?_id=<?=$row['id_slide']?>" class='btn btn-xs btn-success '><i class="fa fa-edit "></i></a>
