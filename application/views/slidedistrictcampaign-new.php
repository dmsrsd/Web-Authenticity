...
<div class="panel panel-default">
	...
	?>	
	<form action="<?=base_url()?>cms/logic/slidedistrictcampaignProses" method="post" data-parsley-validate enctype="multipart/form-data">
	<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-5"> 
						...
						<img src='<?php echo base_url();?>uploads/districtcampaign/<?php echo $data['image'];?>' height='150' class='img'>
						<?php endif?>
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-5"> 
						...
						<img src='<?php echo base_url();?>uploads/districtcampaign/<?php echo $data['image_mobile'];?>' height='150' class='img'>
						<?php endif?>
		...
		<div class="panel-footer">
			...
			<a href='<?=$url?>slidedistrictcampaign' class='btn btn-default'>Back</a>
