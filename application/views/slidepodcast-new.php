...
<div class="panel panel-default">
	...
	?>	
	<form action="<?=base_url()?>cms/logic/slidepodcastProses" method="post" data-parsley-validate enctype="multipart/form-data">
	<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-sm-5"> 
						...
						<img src='<?php echo base_url();?>uploads/podcast/<?php echo $data['image_mobile'];?>' height='150' class='img'>
						<?php endif?>
		...
		<div class="panel-footer">
			...
			<a href='<?=$url?>slidepodcast' class='btn btn-default'>Back</a>
