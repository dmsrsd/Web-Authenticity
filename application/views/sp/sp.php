...
Event : <b><?php echo $tiket["judul"];?></b><br>
Pembelian Tiket : <b><?php echo $totalbeli;?></b><br>
Total Scan : <b><?php echo $totalscan;?></b>
</div>
<div class="list-group">
	<a href="javascript:void(0);" class="list-group-item active">
	<i class='fa fa-home'></i> Home
	</a>
	<a href="<?=base_url();?>sp/dashboard/tiketmasuk" class="list-group-item"><span class="badge"><i class='fa fa-chevron-right'></i></span><i class='glyphicon glyphicon-qrcode'></i> Scan QR Tiket Masuk</a>
	<a href="javascript:void(0);" data-target="purchase" class="list-group-item showmodal">
		<span class="badge"><i class='fa fa-chevron-right'></i></span><i class='glyphicon glyphicon-qrcode'></i> Show QR Authentic On Ground
	</a>
...
<div id="purchase" class="modal fade" role="dialog">
	...
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title">QR Authentic On Ground</h4>
		</div>
