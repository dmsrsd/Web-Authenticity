...
<div class="panel panel-default">
	...
	?>		
	<form action="<?=base_url()?>cms/logic/writeProses" method="post" data-parsley-validate enctype="multipart/form-data">
		...
		<div class="panel-body"> 
			...
			<div class="form-group">
				<div class="row">
					<div class="col-sm-2">
						<label class="control-label">Thumbnail  </label><br><em>261 x 196</em>
					</div>
					<div class="col-sm-8"> 
