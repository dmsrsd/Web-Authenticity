<?php
if($_SESSION["verifytnmc"] != "FileManager4TinyMCE") die('forbidden');
...
$base_url       = BASEPATH.'uploads/tinymce/'; //Link url to upload file
/* localhost*/
$current_path     = rtrim($_SERVER['DOCUMENT_ROOT'],'/').'/uploads/tinymce/'; // relative url to upload file location path
$upload_dir   = rtrim($_SERVER['DOCUMENT_ROOT'],'/').'/assets/webadmin/tinymce/plugins/filemanager/thumbs/'; // relative url to create thumbs for view from upload file location path
/* END LOCALHOST */
/* PASTISUKA.COM */
